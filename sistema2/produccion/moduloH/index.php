...
<body class="bg-light"> 
    ...
    <header align="center">
        ...
        <h5 class="text-muted">M Ó D U L O  H</h5>
    </header>   
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <?php
                                $sql="SELECT FORMAT(SUM(peso_unitario),2) from tabla WHERE modulo='H' AND cancelados is null";
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <?php
                                $sql2="SELECT FORMAT(SUM(peso_unitario),2) from tabla WHERE contratista IS NOT NULL AND modulo='H' AND cancelados is null";          
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
                                        <?php                                
                                        $sql3="SELECT FORMAT(SUM(peso_unitario)/(SELECT SUM(peso_unitario) FROM tabla WHERE modulo='H' AND cancelados is null)*100,2) AS PORCENTAJE FROM tabla WHERE modulo='H' AND contratista IS NOT NULL AND cancelados is null";                                    
