$(document).ready(function() {
	...
	tablaUsuarios = $('#tablaUsuarios').DataTable({
	    ...
	    createdRow: function(row, data) {
            if (data["enviado"] == 'SI' && data["cancelados"] === null) {
...
enviado = fila.find('td:eq(7)').text();
remision = fila.find('td:eq(8)').text();
...
opcion = 3; //eliminar        
var respuesta = confirm("¿Está seguro de borrar el campo ENVIADO y REMISION del registro " + id_tabla + "?");
if (respuesta) {
	$.ajax({
		url: "bd/crud.php",
		type: "POST",
