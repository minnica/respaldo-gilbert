					...
					<div class="card-body">
						<div class="row no-gutters align-items-center">
							<div class="col mr-2">
								...
								<?php
								$sql2="SELECT FORMAT(SUM(peso_unitario),2) from tabla WHERE enviado='SI' and modulo='K' AND cancelados is null";          
						...
						<div class="row no-gutters align-items-center">
							<div class="col mr-2">
								...
								<div class="row no-gutters align-items-center">
									<div class="col-auto">
										<?php                                
										$sql3="SELECT FORMAT(SUM(peso_unitario)/(SELECT SUM(peso_unitario) FROM tabla WHERE modulo='K' AND cancelados is null)*100,2) AS PORCENTAJE FROM tabla WHERE modulo='K' AND enviado='SI' AND cancelados is null";                                    
