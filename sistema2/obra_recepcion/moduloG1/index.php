                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <?php
                                $sql2="SELECT FORMAT(SUM(peso_unitario),2) from tabla WHERE montaje='SI' AND modulo='G1'";          
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
                                        <?php                                
                                        $sql3="SELECT FORMAT(SUM(peso_unitario)/(SELECT SUM(peso_unitario) FROM tabla WHERE modulo='G1')*100,2) AS PORCENTAJE FROM tabla WHERE modulo='G1' AND montaje='SI'";                                    
