...
<body class="bg-light"> 
    ...
    <header align="center">
        <h4 class="text-dark">C A L I D A D</h4>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <?php
                                $sql="SELECT FORMAT(SUM(peso_unitario),2) from tabla WHERE modulo='G2'";
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <?php
                                $sql2="SELECT FORMAT(SUM(peso_unitario),2) from tabla WHERE status='TERMINADO' and modulo='G2'";          
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
                                        <?php                                
                                        $sql3="SELECT FORMAT(SUM(peso_unitario)/(SELECT SUM(peso_unitario) FROM tabla WHERE modulo='G2')*100,2) AS PORCENTAJE FROM tabla WHERE modulo='G2' AND status='TERMINADO'";                                    
