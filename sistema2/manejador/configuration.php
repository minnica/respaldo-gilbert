...
return [
    ...
    'timezone' => 'America / Mexico_City', // https://www.php.net/manual/en/timezones.php
    'download_inline' => ['pdf'], // download inline in the browser, array of extensions, use * for all

    'frontend_config' => [
        'app_name' => 'Gilbert Archivos',
        'app_version' => APP_VERSION,
        'language' => 'spanish',
        'logo' => 'dist/img/logo.png',
        'upload_max_size' => 100 * 1024 * 1024, // 100MB
        'upload_chunk_size' => 1 * 1024 * 1024, // 1MB
        'upload_simultaneous' =>100,
        'default_archive_name' => 'archivo.zip',
        'editable' => ['.txt', '.css', '.js', '.ts', '.html', '.php', '.json', '.md','.dwg','.xlsx', '.csv','.docx'],
    ...
    'services' => [
        ...
        'Filegator\Services\View\ViewInterface' => [
            ...
            'config' => [
                'add_to_head' => '<link rel="shortcut icon" href="dist/img/logo.ico">',
                'add_to_body' => '',
            ],
        ],
