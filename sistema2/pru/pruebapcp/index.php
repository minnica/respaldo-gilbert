...
<body> 
    <header>
        <div class="container">        
            ...
            <font color="black" size="6" face="Elephant" > <center>MÓDULO E2</center></font>
        ...
        <div align="right">
            <table cellspacing="40" cellpadding="1" border="1">
                ...
                <tbody>
                    ...
                    $sql2="SELECT FORMAT(SUM(peso_unitario),2) from tabla WHERE liberado='SI' AND modulo='E2' AND cancelados is null";
    ...
    $(document).ready(function() {
        ...
        tablaUsuarios = $('#tablaUsuarios').DataTable({
            ...
            createdRow: function(row, data) {
                ...
                if (data["liberado"] == 'SI') {
                    $("td", row).css('background-color', '#B2F75B'); //addClass('table-success')
                } else {
                    $("td", row).css('background-color', '#F55861'); //addClass('table-success')
                }
            },
