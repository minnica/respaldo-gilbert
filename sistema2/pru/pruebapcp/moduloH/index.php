...
<body> 
    <header>
        <div class="container">        
            ...
            <font color="black" size="6" face="Elephant" > <center>MÓDULO H</center></font>
        ...
        <div align="right">
            <table cellspacing="40" cellpadding="1" border="1">
                ...
                <tbody>
                    ...
                    $sql2="SELECT FORMAT(SUM(peso_unitario),2) from tabla WHERE liberado='SI' AND modulo='H' AND cancelados is null";
