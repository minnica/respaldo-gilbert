...
<body> 
    <header>
        <div class="container">        
            ...
            <font color="black" size="6" face="Elephant" > <center>MÓDULO E3</center></font>
            ...
            <table cellspacing="40" cellpadding="1" border="1">
                <thead style="background:#b8b8b8">
                    <tr>
                        ...
                        <th style="text-align: center">PORCENTAJE</th>  </th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    $sql="SELECT FORMAT(SUM(peso_unitario),2) from tabla WHERE modulo='E3' AND cancelados is null";
                    $sql2="SELECT FORMAT(SUM(peso_unitario),2) from tabla WHERE liberado='SI' AND modulo='E3' AND cancelados is null";
                    $sql3="SELECT FORMAT(SUM(peso_unitario)/(SELECT SUM(peso_unitario) FROM tabla WHERE modulo='E3' AND cancelados is null)*100,2) AS PORCENTAJE FROM tabla WHERE modulo='E3' AND liberado='SI' AND cancelados is null";
