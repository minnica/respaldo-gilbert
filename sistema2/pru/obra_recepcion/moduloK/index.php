        ...
        <div align="right">
            <table cellspacing="40" cellpadding="1" border="1">
                ...
                <tbody>
                    ...
                    $sql2="SELECT FORMAT(SUM(peso_unitario),2) from tabla WHERE montaje='SI' AND modulo='K' AND cancelados is null";
                    $sql3="SELECT FORMAT(SUM(peso_unitario)/(SELECT SUM(peso_unitario) FROM tabla WHERE modulo='K' AND cancelados is null)*100,2) AS PORCENTAJE FROM tabla WHERE modulo='K' AND montaje='SI' AND cancelados is null";
