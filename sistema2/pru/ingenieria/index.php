...
<body>
  ...
  <ul  style= "overflow: auto";>
    ...
    <li><a href="../areas.php" style="text-decoration: none; color:#000"><span>CAPTURAR <i class="fal fa-file-alt fa-spin" style="color: #ff6b6b;"></i></span></a></li>
    <li><a href="../areas.php" style="text-decoration: none; color:#000"><span>IMPRIMIR<i class="fal fa-print"></i></span></a></li>
