                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <?php
                                $sql="SELECT FORMAT(SUM(peso_unitario),2) as peso_total from tabla WHERE modulo='J' AND cancelados is null";
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <?php
                                $sql2="SELECT FORMAT(SUM(peso_unitario),2) as peso_liberado from tabla WHERE liberado='SI' AND modulo='J' AND cancelados is null";          
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
                                        <?php                                
                                        $sql3="SELECT FORMAT(SUM(peso_unitario)/(SELECT SUM(peso_unitario) FROM tabla WHERE modulo='J' AND cancelados is null)*100,2) AS PORCENTAJE FROM tabla WHERE modulo='J' AND liberado='SI' AND cancelados is null";                                   
